...
from weakident_utils.calculations import rms
'''
...
def load_data(filepath: str,
    ...
    with open(filename, "rb") as f:
        u = np.load(f, allow_pickle=allow_pickle)
        xs = np.load(f, allow_pickle=allow_pickle)
        true_coefficients = np.load(f, allow_pickle=allow_pickle)
    # print(u, xs, true_coefficients)
